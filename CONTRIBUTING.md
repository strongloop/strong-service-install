...
Thank you for your interest in `strong-service-install`, an open source project
administered by StrongLoop.

Contributing to `strong-service-install` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-service-install)
